...
import { HiCheck, HiMail, HiPhone, HiArrowRight, HiExternalLink } from "react-icons/hi";
...
const Contact = () => {
  ...
  return (
    ...
    >
      {/* Soft warm ambient background glow inspired by Dribbble SaaS design */}
      <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[900px] h-[500px] bg-gradient-to-br from-amber-200/25 via-orange-100/20 to-transparent dark:from-amber-500/5 dark:via-orange-500/5 blur-3xl pointer-events-none rounded-full" />

      <div className="relative z-10 max-w-6xl w-full mx-auto bg-white dark:bg-slate-900 rounded-[32px] border border-slate-200/90 dark:border-slate-800 shadow-2xl p-6 sm:p-10 lg:p-14">
            ...
            <div className="grid sm:grid-cols-2 gap-4 pt-4">
              ...
              <div className="bg-slate-50 dark:bg-slate-800/60 border border-slate-200/80 dark:border-slate-700/60 rounded-2xl p-4 sm:p-5 flex flex-col justify-between">
                ...
                <a
                  ...
                  className="mt-3 inline-flex items-center gap-1.5 text-xs font-semibold text-slate-800 dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-400 break-all transition"
                >
              ...
              <div className="bg-slate-50 dark:bg-slate-800/60 border border-slate-200/80 dark:border-slate-700/60 rounded-2xl p-4 sm:p-5 flex flex-col justify-between">
                ...
                <a
                  ...
                  className="mt-3 inline-flex items-center gap-1.5 text-xs font-semibold text-slate-800 dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-400 transition"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full bg-white dark:bg-slate-900 text-slate-900 dark:text-white text-xs sm:text-sm px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700/80 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none transition shadow-2xs"
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    className="w-full bg-white dark:bg-slate-900 text-slate-900 dark:text-white text-xs sm:text-sm px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700/80 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none resize-none transition shadow-2xs"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full py-3.5 px-6 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm sm:text-base tracking-wide flex items-center justify-center gap-2 transition-all duration-200 shadow-lg shadow-blue-500/25 active:scale-[0.99] cursor-pointer disabled:opacity-60"
                >
